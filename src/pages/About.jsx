        ...
        <div className="inner-wrapper flex-row-wrap two-col">
          <div className="about-intro-box box">
            ...
            <div className="about-bio">
              ...
              <p>
                Hello! I'm Zach. I have a background in Software Engineering and
                I am currently working in customer service and billing at{" "}
                <strong>Surf Internet</strong> in La Porte, IN.
              </p>
              <p>
                I am passionate about full-stack development, specifically
                specializing in the <strong>MERN stack</strong>. I am actively
                looking to return to a full-time engineering role where I can
                utilize my fluency in JavaScript.
              </p>
              <p>
                When I'm not coding, I enjoy spending time with my family—my mom
                Robyn, my brother Carlos, and my boyfriend Ellis.
              </p>
