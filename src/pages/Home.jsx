...
// import ProjectCard from '../components/ProjectCard'; // Import Grid Card
...
//   // --- 1. DEFINE IMAGE OPTIONS ---
//   const darkOptions = [
//     { name: 'Default (Tech Network)', value: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=2072&auto=format&fit=crop' },
//     { name: 'Moody Forest', value: 'https://images.unsplash.com/photo-1511497584788-876760111969?q=80&w=2074' },
//     { name: 'Clean Concrete', value: 'https://images.unsplash.com/photo-1485637701894-09ad422f6de6?q=80&w=1994' },
//     { name: 'Circuit Board', value: 'https://images.unsplash.com/photo-1518770660439-4636190af475?q=80&w=2070' },
//     { name: 'Deep Space', value: 'https://images.unsplash.com/photo-1462331940025-496dfbfc7564?q=80&w=2022' },
//   ];

//   const lightOptions = [
//     { name: 'Dandelion Seeds', value: '/images/Backgrounds_Dandelion_seeds__background_Ubuntu_100911_24.jpg' },
...
//         <div className="theme-selector" style={{ marginTop: '25px', display: 'inline-block' }}>
//           <label style={{ marginRight: '10px', fontSize: '0.9rem', color: 'var(--text-secondary)' }}>
//             {isDarkMode ? '🎨 Dark Theme:' : '☀️ Light Theme:'}
//           </label>
//           <select
//             value={selectedBg}
...
//           >
//             {currentOptions.map((option, index) => (
//               <option key={index} value={option.value} style={{ background: isDarkMode ? '#333' : '#fff' }}>
//                 {option.name}
//               </option>
//             ))}
//           </select>
...
//               <Carousel fade style={{ maxWidth: '800px', margin: '0 auto', border: '1px solid var(--border-color)', borderRadius: '10px', overflow: 'hidden' }}>
//                 {completedProjects.map((project) => (
//                   <Carousel.Item key={project._id} interval={5000}>
//                     <Link to={`/project/${project._id}`}>
//                         <div style={{ height: '400px', background: '#000', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
//                             <img
//                             className="d-block w-100"
//                             src={project.imageUrls && project.imageUrls.length > 0 ? `${import.meta.env.VITE_API_URL}${project.imageUrls[0]}` : 'https://via.placeholder.com/800x400'}
//                             alt={project.title}
//                             style={{ objectFit: 'cover', height: '100%', width: '100%', opacity: '0.9' }}
//                             />
//                         </div>
//                     </Link>
//                     <Carousel.Caption style={{ background: 'rgba(0,0,0,0.7)', padding: '10px', borderRadius: '5px' }}>
//                       <h3 style={{color: '#fff', textShadow: '1px 1px 2px black'}}>{project.title}</h3>
//                       <p style={{color: '#ddd'}}>{project.description ? project.description.substring(0, 80) + '...' : ''}</p>
//                     </Carousel.Caption>
//                   </Carousel.Item>
//                 ))}
//               </Carousel>
...
//             <>
//               <hr style={{ margin: '3rem 0', borderColor: 'var(--border-color)' }} />
//               <h2 style={{ color: 'var(--text-primary)', margin: '1rem 0' }}>🚧 Currently In Progress</h2>
